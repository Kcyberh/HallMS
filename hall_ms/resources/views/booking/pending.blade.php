        ...
        <table id="myTable" class="table">
            ...
            @foreach ($payment as $payment)
                    <tr>
                        ...
                        <a href="#" class=""><button type="button" class="btn btn-primary btn-sm mt-1" data-bs-toggle="modal" 
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <strong>User:</strong> {{ $payment->user->name }} <br>
            <strong>Hall Name:</strong> {{ $payment->booking->hall->name }} <br>
            <strong>Room Number:</strong> {{ $payment->booking->room->number }}<br>
            <strong>Room:</strong> {{ $payment->booking->room->type }} in 1<br>
            <strong>Starting Date:</strong> {{ $payment->booking->started_at }} <br>
            <strong>Ending Date:</strong> {{ $payment->booking->ending_at }} <br>
